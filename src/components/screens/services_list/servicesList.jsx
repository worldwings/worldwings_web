    ...
    return (
        <>
            ...
            <div className={styles.servicesPage}>
                <PageBanner
                    title={title}
                    image={services.length > 0 && services[0].images?.length > 0 ? `/${services[0].folderName}/${services[0].images[0]}` : "/blog/blog-1.jpg"}
                />
                            ...
                            services.map((service) => (
                                <div className={styles.serviceCard} key={service.id}>
                                    ...
                                    <div className={styles.content}>
                                        ...
                                        <Link href={`/services/${category}/${service.id}`} className={styles.btn}>
                                            View Details
                                        </Link>
                                    </div>
                                </div>
